...
const setPageChromeOpacity = (opacity: string) => {
  document.querySelector<HTMLElement>('main')?.style.setProperty('opacity', opacity);
  document.querySelector<HTMLElement>('nav')?.style.setProperty('opacity', opacity);
};
