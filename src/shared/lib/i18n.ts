export const translations = {
  zh: {
    ...
    aboutPage: {
      ...
      visitHome: '访问主页',
      lastSync: '上次同步:',
      dataDisclaimer: '数据仅供参考，真实数据请以官方平台为准。',
      latestUpdates: '最新动态',
  ...
  ja: {
    ...
    aboutPage: {
      ...
      visitHome: 'ホームページへ',
      lastSync: '最終同期:',
      dataDisclaimer: 'データは参考用です。正確なデータは各公式プラットフォームをご確認ください。',
      latestUpdates: '最新の更新',
  ...
  en: {
    ...
    aboutPage: {
      ...
      lastSync: 'Last Sync:',
      dataDisclaimer: 'Data is for reference only. For accurate data, please refer to the official platforms.',
