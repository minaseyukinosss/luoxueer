...
import { type PlatformTheme, type SocialStats } from "@/features/about/constants";
...
export const SocialSectionCreative = ({
  ...
  useEffect(() => {
    ...
    autoPlayTimerRef.current = setInterval(playNext, 10000);
  ...
  const handleManualSwitch = (index: number) => {
    ...
    resumeAutoPlayTimerRef.current = setTimeout(() => setIsAutoPlaying(true), 6000);
  };
