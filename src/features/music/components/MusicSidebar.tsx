...
export default function MusicSidebar({ onSongSelect }: MusicSidebarProps) {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden pl-6 pr-2 md:px-0">
      <div className="flex items-center gap-2 mb-6 md:mb-8 px-2">
        ...
        <span className="text-xs font-mono text-gray-400">{songList.length.toString().padStart(2, '0')}</span>
      </div>
